...
import { faAngleDown, faAngleUp, faLayerGroup } from '@fortawesome/free-solid-svg-icons';

export default function CategoryGrid({ categories }: { categories: any[] }) {
    const [isExpanded, setIsExpanded] = useState(false);
    
    // Initial 6 items show honge
        ...
        <div className="bg-white rounded-[2.5rem] p-8 shadow-[0_4px_25px_rgb(0,0,0,0.04)] border border-slate-100">
            <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center">
                    <FontAwesomeIcon icon={faLayerGroup} className="text-[#ff912f] text-lg" />
                </div>
