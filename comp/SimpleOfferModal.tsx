...
const SimpleOfferModal = ({ data, onClose, domain, merchantHref, finalDiscountTag, merchantImg, productImg }: Props) => {
    ...
    return ReactDOM.createPortal(
        <div 
            /* Yahan changes ki hain: top offset hata kar sirf inset-0 aur z-index increase kar diya hai */
        ...
        >
            <div 
                /* Max height ko 85vh kar diya taake bottom se door rahe aur proper center lagay */
                ...
                <div className="overflow-y-auto flex-grow custom-scrollbar">
                    ...
                    <div className="pt-10 pb-5 flex justify-center relative">
                        <div className="relative w-24 h-24 bg-white rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-4 flex items-center justify-center group">
                            {/* Deep Charcoal Color for Premium Tag */}
                            {finalDiscountTag && (
                    ...
                    <div className="px-6 sm:px-8 pb-8 text-center">
                        <div className="flex items-center justify-center gap-3 mb-5">
                            ...
                            <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#1a1612]/5 border border-[#1a1612]/10">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-[#1a1612]">Verified</span>
                            </span>
                        ...
                        <div className="text-left border-t border-gray-100 pt-6">
                            <h4 className="text-[11px] font-black uppercase tracking-widest text-[#1a1612] mb-3">Offer Details</h4>
                            <p className={`text-sm text-gray-500 leading-relaxed ${!showFullDesc && isLongDesc ? 'line-clamp-2' : ''}`}>
