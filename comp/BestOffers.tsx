      ...
      <div className="container relative z-10 mx-auto px-4 lg:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
          <div className="max-w-xl">
            ...
            {/* Compact Heading: Black & Orange Theme */}
        ...
        {/* ── Grid of Cards: Exactly as per your requirement ── */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-4 md:gap-5 items-stretch">
          {offersList.slice(0, count).map((offer: OffersOffer, i: number) => (
            <div key={i} className="flex h-full w-full transition-transform duration-300 hover:-translate-y-1">
              <OfferCard
                offer={offer}
