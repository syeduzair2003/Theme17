                ...
                <div className="space-y-1.5 relative z-10">
                  {cat.slice(0, 4).map((category, i) => (
                    ...
                    >
                      ...
                      <FontAwesomeIcon
                        icon={faArrowRight}
                        className="w-3 h-3 text-gray-200 group-hover:text-[#8bc94a] -translate-x-2 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all"
                      />
                    </Link>
                  ))}
                </div>
