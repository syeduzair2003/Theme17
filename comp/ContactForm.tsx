...
const ContactForm = ({ domain }: Props) => {
  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.03)] h-full relative overflow-hidden group">
      ...
      <h2 className="text-3xl font-black text-[#1a1612] mb-2 tracking-tight uppercase">
        Get In Touch
      </h2>
      <p className="text-gray-400 mb-10 font-medium text-sm tracking-wide">
        We&apos;d love to hear from you. Please fill out this form.
      </p>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="relative group/field">
          <label className="block text-[10px] font-black text-[#1a1612] uppercase tracking-[0.2em] mb-2 ml-5">
            Your Name
          </label>
          <input
            type="text"
