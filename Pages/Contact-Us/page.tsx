          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="order-1 lg:order-2 flex flex-col gap-8">
              <div className="space-y-4">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      pageData?.details ||
                      "We're here to help you find the best deals and answer any questions you may have.",
                  }}
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {pageData?.address && (
                  <div className="group bg-[#1a1612] rounded-3xl p-6 transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-black/5">
                    ...
                    <h4 className="font-bold text-white mb-1 text-sm tracking-wide">
                      Main Office
                    </h4>
                ...
                {pageData?.email && (
                  <div className="group bg-white rounded-3xl p-6 border border-gray-100 transition-all duration-300 hover:border-[#FF5F1F]/30 hover:shadow-xl">
                    ...
                    <h4 className="font-bold text-[#1a1612] mb-1 text-sm tracking-wide">
                      Email Us
                    </h4>
                    <p className="text-[#FF5F1F] text-xs font-bold truncate">
                      {pageData.email}
                    </p>
                  </div>
                )}
              ...
              <div className="bg-[#f2f2f2] rounded-[2.5rem] p-6 border border-gray-200 shadow-inner">
                <h5 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] mb-5 text-center">
                  Follow our journey
                </h5>
                <div className="flex flex-wrap gap-3 justify-center">
                  {socialPlatforms.map((platform) => {
                    const link =
                      fullPageData?.company_data?.[
                        platform.key as keyof typeof fullPageData.company_data
                      ];
                    if (!link) return null;
                    ...
                    return (
                      ...
                      >
                        ...
                        />
                        <span className="text-[9px] font-black uppercase tracking-tight text-[#1a1612] group-hover:text-[#FF5F1F]">
                          {platform.label}
                        </span>
                      </Link>
                    );
